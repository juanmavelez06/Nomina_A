...
public class Comerciales {
    ...
    private int Auxilio_Transporte;
    ...
    public double empleado (){
     ...
     public double empleador (){
        ...
        System.out.println( "Total de descuento Empleador - Liquidacion_EPS : " + eps_liquidacion_a);
        System.out.println( "Total de descuento Empleador - Liquidacion_Pension : " + pension_liquidacion_a);
       ...
       public Comerciales (String nombre, int salariobase, double eps, double pension, 
               ...
               double parafiscales, double intereses_cesantias,double eps_empleador, double pension_empleador){
       this.Nombre = nombre;
    ...
    /**
     * @param Vacaciones the Vacacione to set
     */
     ...
     */
    public int getAuxilio_Transporte() {
     ...
     */
    public void setAuxilio_Transporte(int Auxilio_Transporte) {
